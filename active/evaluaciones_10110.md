...
El laboratorio se evalúa con cuatro tareas, de las cuáles se elimina la peor nota (A menos que se haya sancionado un 1.0 por falta al Código de Honor del curso, en cuyo caso, dicha nota no se borra).

| Calificación | Ponderación | Fecha | Contenidos |
| ------------ | ------| -------- | ------- |
|Tarea 1 (T1)  | 33.33% | 24-10-26 | Hasta Iteración |
|Tarea 2 (T2)  | 33.33% | 07-11-26 | Hasta Funciones propias |
|Tarea 3 (T3)  | 33.33% | 28-11-26 | Hasta Listas |
|Tarea 4 (T4)  | 33.33% | 12-12-26 | Hasta Archivos |
